    ...
    <br /> <br />
                ...
                <label>
                  <select
                    ...
                    onChange={(e) =>
                      this.updateInput("showGroup", e.target.value)
                    }
                  >
                    <option value=""></option>
                    <option value="personal">Personal</option>
          ...
          <Appx list={this.state.list}/>
         if(this.state.showGroup===""){
           <App1 list={this.state.list} newItem={this.state.newItem} newItemType={this.state.newItemType}/>
         }    
         else if(this.state.showGroup==="personal"){
           <App2 list1={this.state.list1} newItem={this.state.newItem} newItemType={this.state.newItemType}/>
         }  
          else if(this.state.showGroup==="office"){
             <App3 list2={this.state.list2} newItem={this.state.newItem} newItemType={this.state.newItemType}/>
          }
          else if(this.state.showGroup==="shopping"){
              <App4 list3={this.state.list3} newItem={this.state.newItem} newItemType={this.state.newItemType}/>
          }
